...
class BmlehScraper(Scraper):
    ...
    _URL_PREFIX: str = "https://www.bmleh.de/"
    _URL: str = f"{_URL_PREFIX}SiteGlobals/Functions/RSSFeed/RSSNewsfeed/RSSNewsfeed_NeueBeitraege.xml"
